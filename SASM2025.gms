...
BIS(R,GSS,'INCONVPRO','QBAR')$RSR(R,GSS) = (BISF(R,GSS,'CROPLAND')-BISF(R,GSS,'ACRECO')) * 0.005;
BIS(R,GMB,'INCONVPRO','QBAR')$RSR(R,GMB) = (BISF(R,GMB,'CROPLAND')-BISF(R,GMB,'ACRECO')) * 0.03;
BIS(R,GNS,'INCONVPRO','QBAR')$RSR(R,GNS) = (BISF(R,GNS,'CROPLAND')-BISF(R,GNS,'ACRECO')) * 0.03;
BIS(R,SS,'INCONVPRO','QBAR')$RSR(R,SS)   = (BISF(R,SS,'CROPLAND') -BISF(R,SS,'ACRECO'))  * 0.03;
...
BIS(R,GMB,'INCONVEPRO','QBAR')$RSR(R,GMB) = (BISF(R,GMB,'ACRECO')) * 0.05;
BIS(R,GNS,'INCONVEPRO','QBAR')$RSR(R,GNS) = (BISF(R,GNS,'ACRECO')) * 0.05;
BIS(R,SS,'INCONVEPRO','QBAR')$RSR(R,SS)   = (BISF(R,SS,'ACRECO'))  * 0.05;
...
** PARAMETER DPTC(P)  Diary processing transfer cost  /KMILK 1.000, CHEESE  0.000, CREAM 8.000, BUTTER  0.000/;
DPTC('KMILK') = 1.000;
DPTC('CHEESE') = 0.000;
DPTC('CREAM') = 8.000;
DPTC('BUTTER') = 0.000;
